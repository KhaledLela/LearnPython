...
class ResourceItem(BaseModel):
    ...
    name: str = Field(description="The body of the item, formatted in HTML.")
    tag_names: List[str] = Field(
        description="A list of tags describing the item, which should correspond to Wikipedia article titles.")
    image_prompt: str = Field(description="A prompt for generating a relevant image for the item.")
